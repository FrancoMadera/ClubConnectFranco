...
/// Pantalla para que el administrador gestione el plantel de fútbol amateur
class AdminPlantelAmateurScreen extends StatefulWidget {
  const AdminPlantelAmateurScreen({super.key});

  @override
  State<AdminPlantelAmateurScreen> createState() => _AdminPlantelAmateurScreenState();
}

class _AdminPlantelAmateurScreenState extends State<AdminPlantelAmateurScreen> {
  ...
  // Colección en Firestore para fútbol amateur
  final String collectionName = 'plantel_amateur';
  ...
  /// Construye un campo de formulario reutilizable
  ...
  /// Selector de imagen para jugador
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Hero(
                    tag: 'jugador-amateur-${jugador.id}',
                    child: Container(
                      width: 70,
                      height: 70,
                      decoration: BoxDecoration(
  ...
  /// Menú de opciones para cada jugador
  ...
  Future<void> _confirmarEliminacion(BuildContext context, Integrante jugador) async {
    ...
    if (confirm == true) {
      try {
        setState(() => _isLoading = true);
        await FirebaseFirestore.instance.collection(collectionName).doc(jugador.id).delete();
        setState(() => jugadores.removeWhere((j) => j.id == jugador.id));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Gestión de Plantel Amateur'),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 12),
                          _buildFormField(_lugarNacimientoController, 'Lugar de nacimiento',
                              Icons.location_on),
                          const SizedBox(height: 12),
                          ...
                          ElevatedButton(
                            ...
                            child: const Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text('AGREGAR JUGADOR', style: TextStyle(fontSize: 16)),
                              ],
                            ),
                          ),
                        ],
