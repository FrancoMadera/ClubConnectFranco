...
/// 📌 Pantalla que muestra el plantel profesional de fútbol (jugadores y cuerpo técnico)
class PlantelYCuerpoTecnicoFutbolProfesionalScreen extends StatefulWidget {
  const PlantelYCuerpoTecnicoFutbolProfesionalScreen({super.key});


  @override
  State<PlantelYCuerpoTecnicoFutbolProfesionalScreen> createState() =>
      _PlantelYCuerpoTecnicoFutbolProfesionalScreenState();
}


class _PlantelYCuerpoTecnicoFutbolProfesionalScreenState
    extends State<PlantelYCuerpoTecnicoFutbolProfesionalScreen> {
  ...
  Future<List<Integrante>> _loadJugadores() async {
    final snapshot =
        await FirebaseFirestore.instance.collection('plantel_profesional').get();
